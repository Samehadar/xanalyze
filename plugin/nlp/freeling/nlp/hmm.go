		...
		case BIGRAM:
			{
				nom1 = items[0]
				prob, _ = strconv.ParseFloat(items[1], 64)
				bg := strings.Split(nom1, "github.com/sniperkit/xanalyze/plugin/nlp/freeling")
		...
		case FORBIDDEN:
			{
				...
				ltg := strings.Split(aux, "github.com/sniperkit/xanalyze/plugin/nlp/freeling")
				for i := 0; i < 3; i++ {
				...
				if err {
					...
					tr := strings.Join(stg, "github.com/sniperkit/xanalyze/plugin/nlp/freeling")
					lt := strings.Join(ltg, "github.com/sniperkit/xanalyze/plugin/nlp/freeling")
					lm := strings.Join(l, "github.com/sniperkit/xanalyze/plugin/nlp/freeling")

					s := ""
					if lt != "github.com/sniperkit/xanalyze/plugin/nlp/freeling." || lm != "github.com/sniperkit/xanalyze/plugin/nlp/freeling." {
						s = lm + "#" + lt
					}
		...
		case TAGSET:
			{
				...
				this.Tags = NewTagset(path + "/" + strings.Replace(ftags, "github.com/sniperkit/xanalyze/plugin/nlp/freeling/", "", -1))
				break
			}
		default:
			break
...
func (this *HMMTagger) ProbA_log(state_i *Bigram, state_j *Bigram, w *list.Element) float64 {
	...
	t3 := state_j.Second
	t2t3 := state_j.First + "github.com/sniperkit/xanalyze/plugin/nlp/freeling" + state_j.Second
	t1t2t3 := state_i.First + "github.com/sniperkit/xanalyze/plugin/nlp/freeling" + state_i.Second + "github.com/sniperkit/xanalyze/plugin/nlp/freeling" + t3
