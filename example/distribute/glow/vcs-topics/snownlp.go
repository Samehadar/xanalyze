...
// SnowNLP golang package
// Equivalent to calling python functions with the python C API
// Complexity a bit big, after the situation can not use it
type SnowNLP struct {
...
func pyvar2go(v *python.PyObject) interface{} {
	switch pyvartype(v) {
	case PY_TYPE_LIST:
		// Think of it, I'm afraid I can not turn ah, the elements of the list may be other complex data structures
	}
	return nil
}
